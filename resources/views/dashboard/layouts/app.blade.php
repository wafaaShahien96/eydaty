...
<body
    ...
    <!-- begin:: Header Mobile -->
    @include('dashboard.layouts.includes.header-mobile')
    <!-- end:: Header Mobile -->
    ...
    <script src="{{asset('Dashboard/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js')}}" type="text/javascript"></script>
    <script src="{{asset('Dashboard/assets/plugins/custom/datatables/datatables.bundle.js')}}" type="text/javascript"></script>
