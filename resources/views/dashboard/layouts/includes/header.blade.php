...
-->
    ...
    <div class="kt-header__topbar">
        ...
        <!--begin: Language bar -->
                    ...
                    <div
                        ...
                        <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                            <li class="kt-nav__item kt-nav__item--active">
                                <a href="#" class="kt-nav__link">
                                    <span class="kt-nav__link-icon">
                                        <img src="{{asset('Dashboard/assets/media/flags/226-united-states.svg')}}" alt="" /></span>
                            ...
                            <li class="kt-nav__item">
                                <a href="#" class="kt-nav__link">
                                    <span class="kt-nav__link-icon">
                                        <img src="{{asset('Dashboard/assets/media/flags/128-spain.svg')}}" alt="" /></span>
                            ...
                            <li class="kt-nav__item">
                                <a href="#" class="kt-nav__link">
                                    <span class="kt-nav__link-icon">
                                        <img src="{{asset('Dashboard/assets/media/flags/162-germany.svg')}}" alt="" /></span>
                ...
                <div class="dropdown dropdown-user nav-item mt-4">
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                <div class="kt-header__topbar-user">
                    ...
                    <span class="kt-header__topbar-username kt-hidden-mobile">{{ Auth::guard('doctor')->user()->name }}</span>
                    <img class="kt-hidden" alt="Pic" src="{{asset('Dashboard/assets/media/users/300_25.jpg')}}" />

                    <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
                    <span
                        class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold">{{ substr( Auth::guard('doctor')->user()->name , 0, 1) }}</span>
                </div>
            </div>
            <div
                ...
                <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x"
                    ...
                    <div class="kt-user-card__avatar">
                        ...
                        <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
                        <span
                    class="kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success">{{ substr( Auth::guard('doctor')->user()->name , 0, 1) }}</span>
                    </div>
                    <div class="kt-user-card__name kt-font-success">
