...
<head>
    <base href="../../../">
    <meta charset="utf-8" />
    <title>@yield('title', 'Dashboard | Login')</title>
    ...
    <link href="{{ asset('Dashboard/assets/css/pages/login/login-3.css') }}" rel="stylesheet" type="text/css" />
...
<body
                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
                    <div class="kt-login__container">
                        <div class="kt-login__logo">
                            <a href="#">
                                <img src="{{ asset('Dashboard/assets/media/logos/logo-5.png') }}">
                            </a>
                        </div>
                        <div class="kt-login__signin">
                            ...
                            <form class="kt-form" action="{{ route('admin.login') }}" method="POST">
                                ...
                                <div class="kt-login__actions">
                                    <button type="submit" class="btn btn-brand btn-elevate kt-login__btn-primary">Sign
                                        In</button>
                                </div>
                            </form>
                        </div>
                            ...
                            <form class="kt-form" action="">
                                ...
                                <div class="kt-login__actions">
                                    <button id="kt_login_signup_submit"
                                        class="btn btn-brand btn-elevate kt-login__btn-primary">Sign
                                        Up</button>&nbsp;&nbsp;
    ...
    <script src="{{ asset('Dashboard/assets/js/pages/custom/login/login-general.js') }}" type="text/javascript">
    </script>
